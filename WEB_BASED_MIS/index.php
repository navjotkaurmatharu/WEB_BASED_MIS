...
font-family: 'Quicksand', sans-serif;background-color:#f2f2f2;">
 ...
 <?php
	  ...
	  echo'<img src="adminpanel/img/OCA-full-name-yellow.png" height=20%; width=10%; style="margin-left:29%; margin-bottom:15%; margin-top:13%;" > You are not logged in.&nbsp Please Login to upload a Excel file.&nbsp<a href="loginpage.php" style="color:blue;">Click here.</a>';
